...
var AppComponent = class _AppComponent {
  ...
  static \u0275fac = function AppComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(LayoutService), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 2, vars: 1, consts: [["id", "app-root"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275attribute("data-bs-theme", ctx.layoutService.theme());
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet], template: '<div id="app-root" [attr.data-bs-theme]="layoutService.theme()">\n    <router-outlet></router-outlet>\n</div>\n', styles: ["/* src/app/app.component.scss */\n/*# sourceMappingURL=app.component.css.map */\n"] }]
...
// src/app/core/services/auth/login.guard.ts
var loginGuard = () => {
  const authService = inject(AuthService);
  const router = inject(Router);
  if (authService.isAuthenticated()) {
...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-FQ3UEEDJ.js").then((m) => m.LoginComponent),
    canActivate: [loginGuard]
  },
  {
    path: "",
    loadComponent: () => import("./chunk-4BG5P5YO.js").then((m) => m.LayoutComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-KVVKCBLI.js").then((m) => m.DashboardComponent)
      },
      {
        path: "component-demo",
        loadComponent: () => import("./chunk-OLSU5N2S.js").then((m) => m.ComponentDemoComponent)
      },
      {
        path: "person",
        loadComponent: () => import("./chunk-6CIHLHL4.js").then((m) => m.PersonListComponent)
      },
      {
        path: "person/create",
        loadComponent: () => import("./chunk-7KEMO4NK.js").then((m) => m.PersonEditorComponent)
      },
      {
        path: "person/:id/edit",
        loadComponent: () => import("./chunk-7KEMO4NK.js").then((m) => m.PersonEditorComponent)
      },
      {
        ...
        loadComponent: () => import("./chunk-SR6FAPS4.js").then((m) => m.PersonPreviewComponent)
      },
      {
        path: "kyc",
        loadComponent: () => import("./chunk-5XVRA7UJ.js").then((m) => m.KycListComponent)
      },
      {
        path: "",
...
var apiResponseInterceptor = (req, next) => {
...
function showMessages(messages, snackBar) {
  if (!messages)
    return;
