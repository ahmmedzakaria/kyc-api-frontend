...
(function(ActionTypes2) {
  ActionTypes2[ActionTypes2["CREATE"] = 1] = "CREATE";
  ActionTypes2[ActionTypes2["UPDATE"] = 2] = "UPDATE";
  ActionTypes2[ActionTypes2["DELETE"] = 3] = "DELETE";
  ActionTypes2[ActionTypes2["SEARCH"] = 4] = "SEARCH";
  ActionTypes2[ActionTypes2["LOGIN"] = 5] = "LOGIN";
  ActionTypes2[ActionTypes2["AUTH"] = 6] = "AUTH";
...
// src/app/core/api/environment.ts
var Environment = {
  // production: true,
  // apiUrl: '/api',
  loginUrl: "",
...
var ApiService = class _ApiService {
   ...
   */
  buildHeaders(isMultiPart = false) {
  ...
  post(apiInfo, body = {}, options = {}) {
    ...
    const basePath = [ActionTypes.LOGIN, ActionTypes.AUTH].includes(apiInfo.actionType) ? this.loginUrl : this.baseUrl;
    ...
    return this.http.post(`${basePath}/${apiInfo.apiPath}`, body, requestOptions).pipe(catchError(this.handleError));
  }
  fetchBinaryData(apiInfo, body = {}, options = { responseType: "arraybuffer", observe: "response" }) {
    if (!apiInfo) {
    ...
    return this.post(apiInfo, body, requestOptions).pipe(map((response) => {
      const contentType = response.headers.get("Content-Type");
      const contentDisposition = response.headers.get("Content-Disposition");
      let filename = "download";
      if (contentDisposition) {
        const match2 = contentDisposition.match(/filename\*?=(?:UTF-8''|\"?)([^\";]+)/i);
        if (match2?.[1]) {
          filename = decodeURIComponent(match2[1].replace(/\"/g, ""));
        }
      }
  ...
  fetchImageUrl(apiInfo, body = {}) {
    return this.fetchBinaryData(apiInfo, body).pipe(map(({ blob }) => URL.createObjectURL(blob)));
  }
  /**
   * Error handler
   */
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-RP4NV6HK.js.map
